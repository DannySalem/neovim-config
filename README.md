...
> `DannySalem` with `<your_github_username>` in the commands below

<details><summary> Linux and Mac </summary>

```sh
git clone https://github.com/DannySalem/neovim-config.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/DannySalem/neovim-config.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/DannySalem/neovim-config.git "${env:LOCALAPPDATA}\nvim"
```
...
* Why is the kickstart `init.lua` a single file? Wouldn't it make sense to split it into multiple files?
  * The main purpose of kickstart is to serve as a teaching tool and a reference
    ...
    * [kickstart-modular.nvim](https://github.com/DannySalem/neovim-config)
